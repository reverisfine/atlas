...
function buildNav(cur){
  ...
  w.innerHTML=`<div class="in">
    <a class="brand" href="${cur?'../index.html':'index.html'}">
      <svg width="30" height="30" viewBox="0 0 46 46" aria-hidden="true">
      ...
      <span><span class="bt">행성 지도</span><br><span class="bs">ATLAS</span></span></a>
    <span class="sp"></span>
    ${cur?`<select id="navSel" aria-label="강 선택">${opts}</select>
